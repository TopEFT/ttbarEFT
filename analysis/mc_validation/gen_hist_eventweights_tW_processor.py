...
SM_pt = {"ctGIm": 0.0, "ctGRe":0.0, "cHQ3": 0.0, "ctWRe": 0.0, "cbWRe": 0.0, "cHtbRe": 0.0,
         "cQl311": 0.0, "cQl322": 0.0, "cQl333": 0.0,
...
rwgt4 = {"ctGIm": -1.5, "ctGRe":-1.5, "cHQ3": 5.0, "ctWRe": 5.0, "cbWRe": 12.0, "cHtbRe": 8.0,
         "cQl311": 12.0, "cQl322": 12.0, "cQl333": 12.0,
         "cleQt3Re11": 20.0, "cleQt3Re22": 20.0, "cleQt3Re33": 20.0,
         "cleQt1Re11": 20.0, "cleQt1Re22": 20.0, "cleQt1Re33": 20.0}

rwgt5 = {"ctGIm": -0.5, "ctGRe":-0.5, "cHQ3": 8.0, "ctWRe": 10.0, "cbWRe": 15.0, "cHtbRe": 10.0,
         "cQl311": 15.0, "cQl322": 15.0, "cQl333": 15.0,
         "cleQt3Re11": 20.0, "cleQt3Re22": 20.0, "cleQt3Re33": 20.0,
         "cleQt1Re11": 20.0, "cleQt1Re22": 20.0, "cleQt1Re33": 20.0}
...
class AnalysisProcessor(processor.ProcessorABC):
    def __init__(self, samples, wc_names_lst=[], hist_lst = None, dtype=np.float32, do_errors=False):
        ...
        self._histo_dict = {
            "weights_SM_log"    : Hist(hist.axis.Regular(bins=120, start=-4, stop=2, name="weights_SM_log", label='log(event weights at the SM)'), storage="weight"),
            "weights_pt1_log"  : Hist(hist.axis.Regular(bins=120, start=-4, stop=2, name="weights_pt1_log", label='log(event weights at the pt1)'), storage="weight"),
            "weights_pt2_log"  : Hist(hist.axis.Regular(bins=120, start=-4, stop=2, name="weights_pt2_log", label='log(event weights at the pt2)'), storage="weight"),
            "weights_pt3_log"  : Hist(hist.axis.Regular(bins=120, start=-4, stop=2, name="weights_pt3_log", label='log(event weights at the pt3)'), storage="weight"),
            "weights_pt4_log"  : Hist(hist.axis.Regular(bins=120, start=-4, stop=2, name="weights_pt4_log", label='log(event weights at the pt4)'), storage="weight"),
            "weights_pt5_log"  : Hist(hist.axis.Regular(bins=120, start=-4, stop=2, name="weights_pt5_log", label='log(event weights at the pt5)'), storage="weight"),
        }
