...
if __name__ == '__main__':
    ...
    if executor == 'ddr': 
        ...
        preprocessed_data = read_json_file("/users/hnelson2/ttbarEFT-coffea2025/input_samples/cfgs/xrootd_test.yaml_preprocessed.json")
        ...
        print(f"\n\n")
        print(f"env variables: {ddr.environment_variables}")
        print(f"x509 proxy: {ddr.x509_proxy}")
        # ddr.environment_variables["X509_USER_PROXY"] = ddr.x509_proxy
